...
def test(e=5, iter=0):
    ...
    # Early stopping
    early_stopping = EarlyStopping(monitor='val_loss', patience=2, restore_best_weights=True, min_delta=0.001)

    # Calcul des poids en fonction de la fréquence des classes
    ...
    # Evaluation des performances avec scikit-learn et classification_report
